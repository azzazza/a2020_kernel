...
//heq
  ...
  #define SP0A20_P1_0x17		0x80		//c4 //kl_low   

//sharpness  
#define SP0A20_P2_0xe8         	0x30//0x20 //0x10//10//;sharp_fac_pos_outdoor
#define SP0A20_P2_0xec         	0x36//0x20 //0x20//20//;sharp_fac_neg_outdoor
#define SP0A20_P2_0xe9        	0x30//0x20 //0x0a//0a//;sharp_fac_pos_nr
#define SP0A20_P2_0xed         	0x36//0x20 //0x20//20//;sharp_fac_neg_nr
#define SP0A20_P2_0xea         	0x20//0x20 //0x08//08//;sharp_fac_pos_dummy
#define SP0A20_P2_0xee          0x20//0x20 //0x18//18//;sharp_fac_neg_dummy
#define SP0A20_P2_0xeb         	0x20//0x20 //0x08//08//;sharp_fac_pos_low
#define SP0A20_P2_0xef         	0x20//0x20 //0x08//18//;sharp_fac_neg_low


//saturation

#define SP0A20_P1_0xd3		0x7c//0x77
#define SP0A20_P1_0xd4		0x7c//0x82//0x78
#define SP0A20_P1_0xd5  	0x6c//0x70
#define SP0A20_P1_0xd6  	0x54//0x70
#define SP0A20_P1_0xd7		0x7c//0x77
#define SP0A20_P1_0xd8		0x7c//0x82//0x78
#define SP0A20_P1_0xd9   	0x6c//0x70
#define SP0A20_P1_0xda   	0x54//0x70
#endif
...
static int32_t sp0a20_sensor_power_down(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	pr_err("%s:%d  enter sp0a20 power down--- func \n",
					__func__, __LINE__);
...
int32_t sp0a20_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	pr_err("%s, E. calling i2c_read:, i2c_addr:%d, id_reg_addr:%d\n",
		__func__,
	...
	//CDBG("%s:  read id: %x expected id gc0310:\n", __func__, chipid);
	      pr_err("sp0a20 read chipid = %x" , chipid);
	      pr_err("sp0a20 read chipid2 = %x" , chipid2);
...
//		int val = 0;
	...
	case CFG_POWER_UP:
			pr_err("%s:%d  enter sp0a20 power up func \n",
				__func__, __LINE__);
